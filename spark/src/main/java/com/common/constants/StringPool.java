 ...
 * Copy to jodd.util
 * <p>
 * Pool of <code>String</code> constants to prevent repeating of hard-coded <code>String</code> literals in the code. Due to fact that these are
 * <code>public static final</code> they will be inlined by java compiler and reference to this class will be dropped. There is <b>no</b> performance
 * gain of using this pool. Read: https://java.sun.com/docs/books/jls/third_edition/html/lexical.html#3.10.5
 * <ul>
